...
public class ConfigFileFirstKind {
	...
	public List<cn.storm.pojo.ConfigFileFirstKind> showConfigFirstKind() {
		List<cn.storm.pojo.ConfigFileFirstKind> list = service
	...
	public String firstkindregister(
			@RequestParam("item.firstKindName") String firstKindName,
	...
	public cn.storm.pojo.ConfigFileFirstKind changefirstkind(
			@RequestBody String id) {
		cn.storm.pojo.ConfigFileFirstKind con = service
				.queryConfigFileFirstKindByffkId(Integer.parseInt(id));
	...
	public ModelAndView fisrtkindchangesuccess(@PathVariable("id") Integer id,
			...
			@RequestParam("item.firstKindSaleId") String firstKindSaleId,
			ModelAndView view) {
		cn.storm.pojo.ConfigFileFirstKind config = service
				.queryConfigFileFirstKindByffkId(id);
		config.setFirstKindSalaryId(firstKindSalaryId);
		config.setFirstKindSaleId(firstKindSaleId);
