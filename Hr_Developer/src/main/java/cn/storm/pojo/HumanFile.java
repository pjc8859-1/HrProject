...
/**
 * HumanFileId entity. @author MyEclipse Persistence Tools
 */
...
public class HumanFile implements java.io.Serializable {
	...
	public String toString() {
		return "HumanFileId [hufId=" + hufId + ", humanId=" + humanId
				...
				+ ", hunmaMajorName=" + hunmaMajorName + ", humanTelephone="
				+ humanTelephone + ", humanMobilephone=" + humanMobilephone
				+ ", humanBank=" + humanBank + ", humanAccount=" + humanAccount
				+ ", humanQq=" + humanQq + ", humanEmail=" + humanEmail
				+ ", humanHobby=" + humanHobby + ", humanSpeciality="
				+ humanSpeciality + ", humanSex=" + humanSex
				+ ", humanReligion=" + humanReligion + ", humanParty="
				+ humanParty + ", humanNationality=" + humanNationality
				+ ", humanRace=" + humanRace + ", humanBirthday="
				+ humanBirthday + ", humanBirthplace=" + humanBirthplace
				+ ", humanAge=" + humanAge + ", humanEducatedDegree="
				+ humanEducatedDegree + ", humanEducatedYears="
				+ humanEducatedYears + ", humanEducatedMajor="
				+ humanEducatedMajor + ", humanSocietySecurityId="
				+ humanSocietySecurityId + ", humanIdCard=" + humanIdCard
				+ ", remark=" + remark + ", salaryStandardId="
				+ salaryStandardId + ", salaryStandardName="
				+ salaryStandardName + ", salarySum=" + salarySum
				+ ", demandSalaraySum=" + demandSalaraySum + ", paidSalarySum="
				+ paidSalarySum + ", majorChangeAmount=" + majorChangeAmount
				+ ", bonusAmount=" + bonusAmount + ", trainingAmount="
				+ trainingAmount + ", fileChangAmount=" + fileChangAmount
				...
				+ ", lastlyChangeTime=" + lastlyChangeTime + ", deleteTime="
				+ deleteTime + ", recoveryTime=" + recoveryTime
