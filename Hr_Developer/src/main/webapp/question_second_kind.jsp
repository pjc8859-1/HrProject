  ...
  <body>
  	<form method="post" action="configmajor.do">
			<table width="100%">
				<tr>
					<td>
						<font color="#0000CC">您正在做的业务是：人力资源--客户化设置--人力资源档案管理设置--试题II级分类设置
						</font>
					</td>
				</tr>
				<tr>
					<td align="right">
						<input type="button" value="添加" class="BUTTON_STYLE1"
							onclick="window.location.href='registerQuestionSecond.do'"/>
					</td>
				</tr>
			</table>
...
$(
    ...
    if(value.length>0){
					...
					no=Math.ceil(listlength/5);
						...
						<td class="TD_STYLE2">
							\${value[i].firstKindName}
						</td>
						<td class="TD_STYLE2">
							\${value[i].secondKindId}
						</td>
						<td class="TD_STYLE2">
							\${value[i].secondKindName}
						</td>
						<td class="TD_STYLE2">
							<a href="question_second_kind_delete.jsp?id=\${value[i].qskId}">删除</a>
						</td>
					</tr>
						`;
