...
<html>
  ...
  <body>
  <form action="upchange.do" method="post">
  <input type="hidden" name="sa" value="${sa }">
			<table width="100%">
				...
				<tr>
					<td>
						<div align="right">
							<input type="button" value="重新提交" class="BUTTON_STYLE1" onclick="doEdit();">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="changer" id="changer" value=""  class="INPUT_STYLE2">
					</td>
					<td class="TD_STYLE1">
						变更时间
					</td>
				...
				<tr>
					...
					<td colspan="7" class="TD_STYLE2">
						<textarea name="remark" rows="4" class="TEXTAREA_STYLE1" >${sa.remark }</textarea>
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
