...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  <tr>
    ...
    <option value="${list.majorKindId}">${list.majorKindId}</option>
    </c:forEach>
    </select>
  ...
  <tr>
    ...
    <option value="${list1.majorKindId}">${list1.majorKindName}</option>
    </c:forEach>
    </select>
    </td>
  </tr>
    ...
    <td class="TD_STYLE2">
   <input type="text" name="item.majorName" value="" class="INPUT_STYLE1">
    </td>
  </tr>
...
$("#aa").attr("action","registerMajorSuccess/"+id+"/"+name+".do");
