...
<script type="text/javascript" src="javascript/comm/comm.js"></script>
  ...
  <body>
  	<form name="configfilefirstkindForm" method="post" action="questionfirstkinddelectsuccess">
<table width="100%" >
  <tr>
    <td> 
    <font color="#0000CC">您正在做的业务是：人力资源--客户化设置--人力资源档案管理设置--试题I级分类设置 </font></td>
  </tr>
  <tr>
...
$(
    ...
    $.ajax({
					type:"post",
					url:"changequestionfirrstkind.do",
				   	dataType:"json",
