...
<script type="text/javascript" src="javascript/comm/comm.js"></script>
  ...
  <body>
  	<form name="configfilefirstkindForm" method="post" action="questionseconddelectsuccess">
<table width="100%" >
  <tr>
    <td> 
...
$(
    ...
    $.ajax({
					type:"post",
					url:"changeQuestionSecondKind.do",
				   	dataType:"json",
    ...
    <td width="81%" class="TD_STYLE2"><input type="text" name="item.majorKindId" value="\${result.firstKindId}" readonly="readonly" class="INPUT_STYLE1"></td>
  </tr>
  <tr>
    <td class="TD_STYLE1">职位分类名称</td>
    <td class="TD_STYLE2"><input type="text" name="item.majorKindName" value="\${result.firstKindName}" readonly="readonly" class="INPUT_STYLE1"></td>
  </tr>
  <tr>
  <td class="TD_STYLE1">职位编号</td>
   <td class="TD_STYLE2"><input type="text" name="item.majorId" value="\${result.secondKindId}" readonly="readonly" class="INPUT_STYLE1"></td>
  </tr>
  <tr>
 <td class="TD_STYLE1">职位名称</td>
  <td class="TD_STYLE2"><input type="text" name="item.majorName" value="\${result.secondKindName}" readonly="readonly" class="INPUT_STYLE1"></td>
  </tr>
