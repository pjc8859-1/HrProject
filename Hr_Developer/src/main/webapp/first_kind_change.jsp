...
<script type="text/javascript" src="javascript/comm/comm.js"></script>
  ...
  <body>
  	<form name="configfilefirstkindForm" method="post" action="fisrtkindchangesuccess">
<table width="100%" >
  <tr>
    <td> 
  ...
  <tr>
    <td align="right"><input type="button" value="提交" class="BUTTON_STYLE1" onclick="toChange()">
...
$(
  ...
  <tr>
    <td class="TD_STYLE1">薪酬发放责任人编号（多个编号之间请用"半角逗号"加"一个空格"隔开，如", "）</td>
    <td class="TD_STYLE2"><textarea name="item.firstKindSalaryId" rows="4"  class="TEXTAREA_STYLE1" >\${result.firstKindSalaryId}</textarea></td>
  </tr>
  <tr>
    <td class="TD_STYLE1">销售责任人编号（多个编号之间请用"半角逗号"加"一个空格"隔开，如", "）</td>
    <td class="TD_STYLE2"><textarea name="item.firstKindSaleId" rows="4"  class="TEXTAREA_STYLE1" >\${result.firstKindSaleId}</textarea></td>
  </tr>
					`;
