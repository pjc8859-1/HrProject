...
<html>
  ...
  <body>
<form name="humanfileForm" method="post" enctype="multipart/form-data" action="hr/humanfilechangesave.do" id="myform">
			<table width="100%">
				<tr>
					<td>
				...
				<tr>
					<td align="right">
						<input type="button" value="保存" class="BUTTON_STYLE1" onclick="mysubmit()">
